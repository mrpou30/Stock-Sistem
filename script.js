...
window.addEventListener("beforeinstallprompt", (e) => {
  ...
  installBtn.style = "position:fixed; bottom:70px; right:20px; z-index:9999; padding:10px 14px; border-radius:12px; background:#ff6b00; color:white;";
